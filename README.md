...
3. On first install a welcome tab points at the bubble (now on every page) and at the toolbar pin.
...
| `popup.*`, `options.*`, `bord.*` | Toolbar popup, word editor, empty board (also the welcome page after install) |
